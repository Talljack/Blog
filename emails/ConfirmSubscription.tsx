...
const ConfirmSubscriptionEmail = ({ link = 'link.com/confirm?fake-token', recipientName = 'Talljack' }) => {
  const previewText = `确认订阅 ${recipientName} 的动态吗？`
